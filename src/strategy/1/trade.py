    ...
    def analyze_trade(self):
        ...
        if self.is_golden:
            ...
            # その他の場合
                ...
                _units = self.units/2
                _event_open_id = 3
                _target_price = self.last_rate + 0.2
                _stop_rate = self.last_rate - 0.08
        ...
        if self.rule_1 and self.rule_2:
            ...
            _units = self.units/2
            _event_open_id = 7
            _target_price = self.last_rate + 0.08
